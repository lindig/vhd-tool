...
(* OASIS_START *)
(* DO NOT EDIT (digest: 2073baccf7022b9945e76d0c7965ac02) *)
(*
...
let setup_t =
  {
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           InternalLibrary "profiling"
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = ["sendfile64_stubs.c"];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                      bs_cclib = [(OASISExpr.EBool true, [])];
                      bs_dlllib = [(OASISExpr.EBool true, [])];
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "=\140,\241\135\029w\004}\190D&\133\0112!";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
